...
class DocumentAddScreen extends JFrame {
    ...
    DocumentAddScreen(String docType) {
        super("INNObrary");
    ...
    private void createGUIBook() {
        ...
        docAddBtn.addActionListener(e -> {
                    ...
                    if (title == null || author == null || price == null || copies == null || edition == null || editionYear == null || publisher == null) {
                        ...
                        authors.add(author);
                        Main.documents.add(new Book(title, authors, Integer.parseInt(edition), Integer.parseInt(editionYear), publisher, Integer.parseInt(price), Integer.parseInt(copies), isBestSeller, isReference));
    ...
    private void updateType() {
        Main.docAdd.setVisible(false);
        Main.docAdd = new DocumentAddScreen((String) docTypeComboBox.getSelectedItem());
